        ...
        try:
            async with message.process():
                ...
                human_readable_to_variable = {
                    ...
                    'ground_angular_velocity_1': 'p_g_0', 'ground_angular_velocity_2': 'q_g_0',
                    'ground_angular_velocity_3': 'r_g_0',
                    ...
                    'flightbody_width': 'flightbody_w', 'flightbody_length': 'flightbody_l',
                    'flightbody_surface_area': 'flightbody_sa',
                    'flightbody_mass': 'flightbody_m', 'flightbody_moment_of_inertia': 'flightbody_I'
                ...
                xyz_s[2] = ((1 - metadata_distributor.constants['E'] ** 2) * r_n_0 + vars['h_0']) * np.sin(
                    vars['eta_0'])
                ...
                await mq_client.send(queue_to, metadata_distributor)
